...
* Agile principles - Makers are Agile enthusiasts and have students practicing Pair Programming throughout the course. Group projects also allows opportunity to run stand-ups and retros.
* Modern development practices - passionate about high-quality, clean code, Makers advocate the use of Test Driven Development (TDD), DRY code, and aspects of SOLID design; such as Single Responsibility and Dependency Injection.
* Working on group projects of 4-5 people has given me the opportunity to work in a team environment and to practice daily stand-ups and retros.

##### Final Project:
The Final Project is completed over 2 weeks as part of a team. My team and I delivered a Travel Journal; the primary interface was a map and users can log in through Facebook, drop a pin, and then upload a picture along with comments and a rating. Pins and User details are saved and then reloaded when they next login.
...
* Present new opportunities to candidates which meets their requirements and matches their technical skills and experience.
...
<div style="text-align: center;"><a href="#tom-moir"> Back to Top </a></div>
